...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/ElBedeawi/AndronixOrigin/master/APT/XFCE4/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/ElBedeawi/AndronixOrigin/master/APT/XFCE4/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/ElBedeawi/AndronixOrigin/master/APT/XFCE4/vncserver-stop -P /usr/local/bin/
