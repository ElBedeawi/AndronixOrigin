...
wget --tries=20 $dlink/GNOME/gnome20.sh -O $folder/root/gnome20.sh
clear
echo "Setting up the installation of Gnome VNC"
...
clear
if [ ! -f /root/gnome20.sh ]; then
    wget --tries=20 $dlink/GNOME/gnome20.sh -O /root/gnome20.sh
    bash ~/gnome20.sh
else
    bash ~/gnome20.sh
fi
...
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/GNOME/vncserver-start -O /usr/local/bin/vncserver-start 
    wget --tries=20 $dlink/GNOME/vncserver-stop -O /usr/local/bin/vncserver-stop
